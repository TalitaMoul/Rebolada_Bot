...
🗳️ Geração automática de enquetes para votação de times
👥 Suporte a partidas 5x5 jogadores
⚙️ Automação de um processo que antes era feito manualmente no servidor
...
⚠️ Para obter um token, acesse o Discord Developer Portal e crie uma aplicação.
